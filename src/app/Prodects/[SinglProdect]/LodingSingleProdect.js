...
const LodingSingleProdect = () => {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3  lg:grid-cols-4 gap-4">


      <div role="status" className="max-w-sm  rounded-lg ">
        <div className="animate-pulse w-full bg-gray-300 h-48 rounded-lg  flex justify-center items-center">
          <svg
        ...
        <div className=" mt-2 w-full flex justify-between items-start animate-pulse">
...
export default LodingSingleProdect;
