...
import ContextSessionProvider from "@/SessionProvider/ContextSessionProvider";
        ...
        <div className="container m-auto px-3 lg:px-7">
          <header className="flex items-center justify-between mt-7">
            <nav className="flex gap-3 items-center ">
              {/* Link User Profail Or Auth  */}

              <Link className="bg-black/20  rounded-full" href={"/Profail"}>
                {session ? (
                  <div className="before:absolute before:bottom-0 before:right-0 before:z-50 before:bg-green-500 before:w-2 before:h-2 before:rounded-full">
                    <Image
